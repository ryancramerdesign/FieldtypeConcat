h1. ProcessWire Concatenate Fieldtype (FieldtypeConcat)

h2. Fieldtype that concatenates the values from one or more other fields at runtime
...
separate full_name field composed of first_name and last_name. 
